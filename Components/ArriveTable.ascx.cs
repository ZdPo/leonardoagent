...
public partial class Components_ArriveTable : System.Web.UI.UserControl
{
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            Data_Schema.ArriveShowRow row = (Data_Schema.ArriveShowRow)((System.Data.DataRowView)e.Row.DataItem).Row;
            if (row.FLIGHTID <= 0)
            {
